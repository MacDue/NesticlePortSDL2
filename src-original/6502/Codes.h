...
/* RTI */
case 0x40:
  M_POP(R.P);R.P|=R_FLAG;M_POP(R.PC.B.l);M_POP(R.PC.B.h);R.PC.W++;break;
...
/* JSR $ssss ABS */
case 0x20: K.B.l=M_RDMEM(R.PC.W++);
           K.B.h=M_RDMEM(R.PC.W);
           M_PUSH(R.PC.B.h);
           M_PUSH(R.PC.B.l);
           R.PC=K;break;
...
/* JMP ($ssss) ABDINDIR */
case 0x6C: M_LDWORD(K);
           R.PC.B.l=M_RDMEM(K.W++);
           R.PC.B.h=M_RDMEM(K.W);
           break;
